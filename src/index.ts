...
async function bootstrap(): Promise<void> {
	...
	const playersCheck = new PlayersCheckService(logger, config);
	...
	resolver.register(DependencyType.PlayersCheck, playersCheck);
	...
	await playersCheck.startPlayersCheck(client);
